...
**Примечание:** Измените `cwd` на путь к вашему проекту.
...
**Важно:** Убедитесь, что вы находитесь в директории проекта при запуске PM2. PM2 автоматически использует директорию, где находится `ecosystem.config.js`, как рабочую директорию приложения.
