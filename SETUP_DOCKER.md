...
- Максимум: 1 CPU, 2GB RAM (настроено для серверов с ограниченными ресурсами)
- Минимум: 0.25 CPU, 512MB RAM
- **Примечание:** Если на вашем сервере меньше ресурсов, закомментируйте секцию `deploy.resources` в `docker-compose.yml`
...
4. **Ограничьте ресурсы** - используйте limits в docker-compose.yml (или закомментируйте, если ресурсов мало)
